...
chsource = Redis:get(Fast..'chsource') or "SSE_MO"
devsource = Redis:get(Fast..'devsource') or "S_E_M_O_E_L_K_B_E_R"
function var(value)  
...
ControllerAll = false
local ListSudos = {Sudo_Id,5183920797,204360148,431536961,0000000000000}
...
xname =  (Redis:get(Fast.."Name:Bot") or "النجوم") 
...
if tonumber(senderr) == 5183920797 then
...
if text == 'مور السورس' or text == 'امد' or text == 'منو' then  
...
local TestText = "  ❲ 𓂄✭𓆩𝙨𝙤𝙪𝙍𝘾𝙀 𝙀𝙡𝙉𝙂𝙤𝙤𝙈𓆪✭𓂁 ❳\nᥫ᭡\n ✭︙*ժᥱ᥎ ꪀᥲ️ꪔᥱ* :  ["..UserInfo.first_name.."](tg://user?id="..UserId_Info.id..")\n✭︙*ժᥱ᥎ ႦᎥ᥆* : [❲ "..Bio.." ❳]"
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = ' ⌯ ˹𝘿𝙚𝙫˼◜ ‌ᯓَِAَhَMَeَD ◞', url = "https://t.mlsbax_dev"}
},
}
...
keyboardd.inline_keyboard = {
{
{text = '❲𝗦𝗢𝗨𝗥𝗖𝗘 𝗤𝗜𝗧𝗛𝗢𝗡❳', url = "https://t.me/QITHON"}
},
{
{text = '❲𝗦𝗢𝗨𝗥𝗖𝗘 𝗤𝗜𝗧𝗛𝗢𝗡❳', url = "https://t.me/QITHON"},
},
...
if text == 'ويزيظيظبظ' or text == 'تيويكبمبز' or text == 'ويزيظبكلم' then  
local UserId_Info = bot.searchPublicChat("FPFFG")
if UserId_Info.id then
local UserInfo = bot.getUser(UserId_Info.id)
local InfoUser = bot.getUserFullInfo(UserId_Info.id)
if InfoUser.bio then
...
local photo = bot.getUserProfilePhotos(UserId_Info.id)
if photo.total_count > 0 then
local TestText = "  ❲ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗤𝗜𝗧𝗛𝗢𝗡 ❳\nᥫ᭡\n ✭︙*ժᥱ᥎ ꪀᥲ️ꪔᥱ* :  ["..UserInfo.first_name.."](tg://user?id="..UserId_Info.id..")\n✭︙*ժᥱ᥎ ႦᎥ᥆* : [❲ "..Bio.." ❳]"
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = ' ꪔY υ᥉ᥱᖇ', url = "https://t.me/FPFFG"}
},
}
local msg_id = msg.id/2097152/0.5 
return https.request("https://api.telegram.org/bot"..Token..'/sendPhoto?chat_id='..msg.chat_id..'&caption='..URL.escape(TestText)..'&photo='..photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id..'&reply_to_message_id='..msg_id..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboardd))
...
keyboardd.inline_keyboard = {
{
{text = '❲ المبرمج جيثون ❳', url = "https://t.me/QITHON"}
},
{
{text = '❲ ⁨𝗦𝗢𝗨𝗥𝗖𝗘 𝗤𝗜𝗧𝗛𝗢𝗡 ❳', url = "https://t.me/QITHOM"},
},
}
local msg_id = msg.id/2097152/0.5 
return https.request("https://api.telegram.org/bot"..Token..'/sendMessage?chat_id=' .. msg.chat_id .. '&text=' .. URL.escape(TestText).."&reply_to_message_id="..msg_id..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboardd))
...
local photo = bot.getUserProfilePhotos(UserId_Info.id)
if photo.total_count > 0 then
local TestText = "  ❲ َِ ََِِ⁨◜ ◜𝙨𝙤𝙪𝙍𝘾𝙀 𝙀𝙡𝙉𝙂𝙤𝙤𝙈◞◞˼⁩ ,❳\nᥫ᭡\n ✭ *ժᥱ᥎ ꪀᥲ️ꪔᥱ* :  [".. ban.first_name.."](tg://user?id="..UserId_Info.id..")\n✭  *ժᥱ᥎ ႦᎥ᥆* : [❲ "..Bio.." ❳]"
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = 'ِ𝙙𝙀𝙑 𝙨𝙀𝙈𝙤  .', url = 't.me/WORLED_SEMO'}, 
},
}
local msg_id = msg.id/2097152/0.5 
 https.request("https://api.telegram.org/bot"..Token..'/sendPhoto?chat_id='..msg.chat_id..'&caption='..URL.escape(TestText)..'&photo='..photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id..'&reply_to_message_id='..msg_id..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboardd))
...
keyboardd.inline_keyboard = {
{
{text = 'ِdev sourse.', url = 't.me/lsbax_dev'}, 
},
{
{text = Creat, url = "https://t.me/"..ban.username..""},
},
...
data = {
{
{text = czczh, url = "https://t.me/QITHON"..bains.username..""},
},
{
{text = Get_Chat.title, url = Info_Chats.invite_link.invite_link}, 
},
...
bot.sendText(5183920797,0,'*\n✭  مرحباً عزيزي سيمو \nشخص ما يحتاج الي مساعده\n⩹━━━━ََِِ⁨◜ 𓂄✭𓆩𝙨𝙤𝙪𝙍𝘾𝙀 𝙀𝙡𝙉𝙂𝙤𝙤𝙈𓆪✭𓂁◞˼⁩ ,━━━━⩺ \n✭  اسمه ↫ '..klajq..' \n✭  ايديه ↫  : '..msg.sender_id.user_id..'\n✭  - معرفة '..basgk..' \n*',"md",false, false, false, false, reply_markup)
end
...
data = {
{
{text = '𝗦𝗢𝗨𝗥𝗖𝗘 𝗤𝗜𝗧𝗛𝗢𝗡', url = 't.me/QITHON'..chsource..''}, 
},
}
}
return send(msg_chat_id,msg_id, [[*
...
{
{text = 'dev qithon', url = 'http://t.me/lsbax_dev'..devsource},
},
}
}
...
if text == (Redis:get(Fast.."Name:Bot") or "النجوم") then
if Redis:get(Fast.."name bot type : ") == "photo" then
  ...
  if photo.total_count > 0 then
    local NamesBot = (Redis:get(Fast.."Name:Bot") or "النجوم")
    local NameBots = {
"قلب "..NamesBot ,
"مين مزعلك بس يعيوني",
"ثانيه واحده بسلك رقم واحده",
"انا مش فاضي النجوم مكاني اهو",
...
local photo = bot.getUserProfilePhotos(Fast)
local CmdStart = '*\n⚡️ أهلآ بك في بوت '..(Redis:get(Fast.."Name:Bot") or "النجوم")..
...
{
{text = '◜ 𝙨𝙤𝙪𝙍𝘾𝙀◞', url = 't.me/QITHON'..chsource..''}, 
},
}
}
...
if not msg.Asasy then 
if not Redis:get(Fast.."Start:Bot") then
local CmdStart = '*\n ✭ ⋮ أهلا بك في بوت '..(Redis:get(Fast.."Name:Bot") or "النجوم")..
...
data = {
{
{text = '« سيمو»',type = 'text'},{text = '«سورس»', type = 'text'},
},
{
{text = '«الغاء الامر»',type = 'text'},
},
...
if text == 'مبرمج السورس ✭' or text == 'مبرمج السورس' or text == 'احمد' then  
local UserId_Info = bot.searchPublicChat("lsbax_dev")
if UserId_Info.id then
local UserInfo = bot.getUser(UserId_Info.id)
local InfoUser = bot.getUserFullInfo(UserId_Info.id)
if InfoUser.bio then
...
keyboardd.inline_keyboard = {
{
{text = '❲ ِ𝙙𝙀𝙑 ❳', url = "https://t.me/lsbax_dev"}
},
}
local msg_id = msg.id/2097152/0.5 
return https.request("https://api.telegram.org/bot"..Token..'/sendPhoto?chat_id='..msg.chat_id..'&caption='..URL.escape(TestText)..'&photo='..photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id..'&reply_to_message_id='..msg_id..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboardd))
...
keyboardd.inline_keyboard = {
{
{text = ' المبرمج احمد ', url = "https://t.me/lsbax_dev"}
},
{
{text = '𝗦𝗢𝗨𝗥𝗖𝗘 𝗤𝗜𝗧𝗛𝗢𝗡', url = "https://t.me/QITHON"},
},
